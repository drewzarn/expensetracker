			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group clearfix">
						<input type="text" class="form-control w-75 float-left id="addtransaction_payee" name="addtransaction_payee" placeholder="Payee" required />
					...
					<div class="splitwrapper">
						<div class="form-group clearfix">
							<input type="text" class="form-control w-75 float-left" id="addtransaction_category" name="addtransaction_category" placeholder="Category" required />
